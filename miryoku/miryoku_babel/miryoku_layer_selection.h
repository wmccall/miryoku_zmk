...
#if !defined(MIRYOKU_LAYER_MODSWAP)
  #if defined (MIRYOKU_LAYERS_FLIP)
    #define MIRYOKU_LAYER_MODSWAP MIRYOKU_ALTERNATIVES_MODSWAP_FLIP
  #else
    #define MIRYOKU_LAYER_MODSWAP MIRYOKU_ALTERNATIVES_MODSWAP
  #endif
#endif
#if !defined(MIRYOKU_LAYERMAPPING_MODSWAP)
